...
class Controller extends Component {
  ...
  render() {
    ...
    let LeftDrawerComponent = this.props.leftDrawerComponent;
    let RightDrawerComponent = this.props.rightDrawerComponent;
    ...
    return (
      <AnimatedView ref={this._attachContainer} style={{ position: 'absolute', height, width: width + 300 + 300, top: 0, left: 0 }}>
        <View style={{ position: 'absolute', backgroundColor: 'pink', height, width: 300, top: 0, left: -300 }}>
          {this.props.leftDrawerComponent && <LeftDrawerComponent activeRoot={navigationState.activeRoot} navigation={this.navigationMethods} />}
        </View>
        <View style={{ backgroundColor: 'blue', width: 300, height, top: 0, right: width * -1 }}>
          {this.props.rightDrawerComponent && <RightDrawerComponent activeRoot={navigationState.activeRoot} navigation={this.navigationMethods} />}
        </View>
