  ...
  render() {
    ...
    return (
      <AnimatedView ref={this._attachContainer} style={{ position: 'absolute', height, width: width + 300 + 300, top: 0, left: 0 }}>
        ...
        <Modal show={navigationState.isModal} frozen={!navigationState.isModal} navState={navigationState.modal} backgroundColor={navigationState.modal.backgroundColor}>
