...
import { initNavigator } from './navigationMethods';
...
class Controller extends Component {
  ...
  constructor(props) {
    ...
    this.navigationMethods = initNavigator(this._handleNavigationAction);
    this.reducer = reducer(props.onNavigate);
  }
  componentDidUpdate() {
    const { leftDrawerVisible, rightDrawerVisible } = this.state.navigationState.toJS();
