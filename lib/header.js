...
class Header extends Component {
  ...
  render() {
    ...
    const defaultTitle = () => <Text style={[styles.title, this.props.sceneProps.headerTitleStyle]}>{this.props.sceneProps.title}</Text>;
    const headerTitle = this.props.sceneProps.renderTitle || defaultTitle;
