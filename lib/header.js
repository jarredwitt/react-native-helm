      ...
      <View style={styles.wrapper}>
        <View style={styles.container}>
          <View style={styles.leftButtonContainer}>
            {this.props.sceneProps.leftButtons.map((renderer, index) => (
          ...
          <View style={styles.titleContainer}>
            <Text style={styles.title}>{this.props.sceneProps.title}</Text>
          </View>
          <View style={styles.rightButtonContainer}>
            {this.props.sceneProps.rightButtons.map((renderer, index) => (
