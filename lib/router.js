...
class Router extends Component {
  ...
  constructor(props) {
    ...
    this.navigationState = this._buildInitialNavigationState(sceneMap, navigationProps.leftDrawerComponent, navigationProps.rightDrawerComponent);
  }
  ...
  _buildInitialNavigationState = (sceneMap, leftDrawerComponent, rightDrawerComponent) => {
    let navState = {
      isModal: false,
    ...
    if (leftDrawerComponent) {
      navState = Object.assign({}, navState, {
        leftDrawer: {
          index: 0,
          routes: [{
            key: 'leftDrawer',
    ...
    if (rightDrawerComponent) {
      navState = Object.assign({}, navState, {
        rightDrawer: {
          ...
          routes: [{
            key: 'rightDrawer',
            component: rightDrawerComponent,
            hideNavBar: true,
          }],
        },
      });
